...
import { Brain, BriefcaseBusinessIcon, LineChart, TrendingDown, TrendingUp } from 'lucide-react';
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
                ...
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        ...
                        <BriefcaseBusinessIcon className={`h-6 w-6 ${outlookColor}`} />
                    </CardHeader>
                    <CardContent>
                ...
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        ...
                        <Brain className={`h-6 w-6 ${outlookColor}`} />
                    </CardHeader>
                    <CardContent>
