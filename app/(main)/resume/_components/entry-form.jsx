...
const formatDisplayData = (dateString) => {
...
const EntryForm = ({ type, entries, onChange }) => {
    ...
    const handleAdd = handleValidation((data) => {
        const formattedEntry = {
            ...data,
            startDate: formatDisplayData(data.startDate),
            endDate: data.current ? "" : formatDisplayData(data.endDate),
        };
    ...
    useEffect(() => {
        if (improvedContent && !isImproving) {
            SelectValue("description", improvedContent);
